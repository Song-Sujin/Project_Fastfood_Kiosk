		...
		case 2:
			do {
				...
				if (answer == 'y' || answer == 'Y') {
					...
					data.getRandomPizza().remove(data.input()-1);
				}
			} while (answer != 'N' && answer != 'n');
			System.out.print(Buyer.message_1);
			Buyer.inputString();
		...
		case 1:
			do {
				...
				if (answer == 'y' || answer == 'Y') {
					...
					if (data.getRandomChicken().size() == 1) {
						data.setNowDiscount(Integer.parseInt(str[1]));
						double minus = ((100 - data.getNowDiscount()) / 100.0);
						data.getRandomChicken().get(0)
								.setPrice((int) (data.getRandomChicken().get(0).getPrice() * minus));
					} else if (data.getRandomChicken().size() > 1) {
						data.setNowDiscount(Integer.parseInt(str[1]));
						double minus = ((100 - data.getNowDiscount()) / 100.0);
						data.getRandomChicken().get(data.getRandomChicken().size() - 1).setPrice(
								(int) (data.getRandomChicken().get(data.getRandomChicken().size() - 1).getPrice()
										* minus));
					}
				}
			...
			for (int i = 0; i < data.getRandomChicken().size(); i++) {
				System.out.format("- %-5s\t  %,36d원\n", data.getRandomChicken().get(i).getName(),
		...
		case 2:
			do {
				...
				if (answer == 'y' || answer == 'Y') {
					...
					data.getRandomChicken().remove(data.input()-1);
				}
			} while (answer != 'N' && answer != 'n');
			System.out.print(Buyer.message_1);
			Buyer.inputString();
